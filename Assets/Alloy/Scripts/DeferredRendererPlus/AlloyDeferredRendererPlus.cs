...
public class AlloyDeferredRendererPlus : MonoBehaviour {
    ...
    public struct SkinSettingsData {
        ...
        [Range(0.0f, 1.0f)] public float BumpBlur;
        ...
        [MinValue(0.0f)] public float BlurDepthRange;
    }
    ...
    public struct TransmissionSettingsData {
        ...
        [MinValue(1.0f)] public float Falloff;
    }
    ...
    public SkinSettingsData SkinSettings = new SkinSettingsData() {
        ...
        BlurWidth = 0.1f,
        BlurDepthRange = 1.0f,
        ColorBleedAoWeights = new Vector3(0.4f, 0.15f, 0.13f),
