...
public class AlloyAreaLightEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (isSpecularAreaLight) {
            EditorGUILayout.Slider(serializedObject.FindProperty("m_radius"), 0.0f, minRange);
        } else {
        ...
        if (isSpecularAreaLight && isPointLight) {
            EditorGUILayout.Slider(serializedObject.FindProperty("m_length"), 0.0f, minRange * 2.0f);
        } else { 
